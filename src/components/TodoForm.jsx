...
function DeleteButton({handleDelete}) {
    ...
    return(
        <button onClick={handleClick} type="button" className="bg-red-400 text-white px-1 md:px-2 text-xl md:text-2xl rounded-xl ml-1 font-makh border-2 border-gray-300 cursor-pointer
                        hover:text-white hover:bg-red-600 hover:shadow-lg hover:shadow-red-500/75
                        transition-all duration-300 ease-in-out"><GiTrashCan className="mb-1 text-3xl md:text-4xl"/></button>
    )
}
