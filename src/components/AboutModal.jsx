    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose}>
            <div className="text-white">
                ...
                <p className="text-md">
                <span className="bg-gray-700  px-2 py-1 rounded-2xl inline-block">This frontend-only Single Page application uses Vite, React.js, and Tailwind CSS.</span><br/>
                ...
                <p className="text-md">
                <span className="bg-gray-700  px-2 py-1  rounded-2xl inline-block">My name is Anton and I am a javascript web developer from Perth, WA.</span><br/>
